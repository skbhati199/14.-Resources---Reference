...
public class FinalizeAppraisalMessage {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FinalizeAppraisalMessage other = (FinalizeAppraisalMessage) obj;
		if (appraisalId == null) {
	...
	public String toString() {
		return "FinalizeAppraisalMessage [appraisalId=" + appraisalId + ", bonusRecordedDateTime="
				+ bonusRecordedDateTime + "]";
	}
